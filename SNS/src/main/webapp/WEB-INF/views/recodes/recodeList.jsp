...
<div id="listpage" style="background-image: url('/SNS/resources/background/recordbackground.jpg');">
...
<!-- 게시글 쓰기 영역 -->
	<span>
		...
		<span class="col-md-2">
		<a href="writeForm"><button type="button" class="btn btn-primary" >녹음 게시물 올리기</button></a>
		</span>
		<span class="col-md-2">
  ...
  <div id="scrollerlist" style="overflow:auto; height:95%; width: 100%">
