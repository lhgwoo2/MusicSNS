...
<body>
<div id="listpage" style="background-image:url('/SNSA/resources/background/managerList.jpg');">
<nav class="navbar navbar-primary navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#pablo">Music Social</a>
			</div>
	...
	<!--navbar 오른쪽 부분 -->
			<div class="collapse navbar-collapse" id="example-navbar-primary">
				...
				<ul class="nav navbar-nav navbar-right">
	                ...
	                <div class="logo">
	                    <img src="/SNSA/resources/profileImage/${user.profilfile}" rel="tooltip" data-placement="bottom" data-html="true">
	                </div>
					</div>
					</li>									
					<li>
...
<div class="container-fluid text-center">
  <div class="row content">
	...
	<br><br><br>	
	      <div id="posts">		
									<span id="tablee" class="thumbnail"  style="width:100%; height:100%;">
										<span style="float: left"><img src="/SNSA/resources/profileImage/${recode.proFilFileName}" style="width: 60px; height: 60px;"> ${recode.author}</span> <br>
										<span style="float: right; margin-left: 10px; font-size: 12px;">작성일:${recode.regDate}</span> <br>
										<br>
										<span style="float: left">${recode.title}</span>
										<span style="float: left">${recode.contents}</span> <br>
										<br>
										<audio src="/SNSA/resources/recode/${recode.filename}" controls	preload="auto" style="width: 100%"></audio>
										<br>
