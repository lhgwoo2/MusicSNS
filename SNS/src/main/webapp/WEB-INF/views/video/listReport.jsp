  ...
  <div class="row content">
	...
	<br><br><br>	
	      <div id="posts">		
									...
									<span style="color: white;">${video.regdate}</span>
									<video style="width: 100%; height: 100%" controls  loop preload="auto">
							  					<source src="/SNSA/resources/video/${video.filename}" type='video/mp4' >
									</video>
									<span style="color: white;">${video.contents}</span>
									<span style="color: white;">${video.num}</span>
									</span>
							<br><br><br><br>
						</div>
	  </div>
