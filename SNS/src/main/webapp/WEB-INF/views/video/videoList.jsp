...
var page = ${videoVO.page}; 
var maxpage =${maxpage};


var pageComment =2;				//댓글페이지 변수
var refComment=0;				//댓글 참조변수
var initcommentText;			//댓글 초기 목록을 가지고 있는 변수
...
$(document).ready(function() {
	...
	$("#scrollerlist").scroll( function() {
		  ...
		  if ( Math.floor((elem[0].scrollHeight - elem.scrollTop())/100) == Math.floor(elem.outerHeight()/100))
		    {
	        	var select1 = "";
 	        	if($('#select').val()==null){
 	        		select1='최신순';
...
function mark(num) {
	 ...
	 serialData.author =  "${secName}";
	   $.ajax({
	        ...
	        success: function(res) {
	        	if(res.ok){	
	        		$('#mark'+num).html('		<img src="/SNS/resources/thumbnailImage/bookmark.jpg" style="width: 20px; height: 20px;"><a style="cursor: pointer;" onclick="markCancel('+num+');" >북마크 취소하기</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'); 
	        	}else{
...
function markCancel(num) {
	 ...
	 serialData.author = "${secName}";
	   $.ajax({
	        ...
	        success: function(res) {
	        	if(res.ok){
	        		$('#mark'+num).html('<img src="/SNS/resources/thumbnailImage/bookmark.jpg" style="width: 20px; height: 20px;"><a style="cursor: pointer;" onclick="mark('+num+');" >북마크</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
	        	}else{
	        		alert("북마크 버튼을 다시 눌러주세요!");
	        	}  
	        }
...
<body>
<div id="listpage" style="background-image: url('/SNS/resources/background/videobackground.jpg');">
...
<div class="container-fluid text-center">
  <div class="row content">
	...
	<span>
		...
		<span class="col-md-2">
		<a href="write?profile=${user.proFilFileName}"><button class="btn btn-primary">동영상 올리기</button></a>
		</span>
		<span class="col-md-2">
		<select id="select" class="btn btn-primary" >
		 	<option selected disabled="disabled" >정렬방법</option>
...
<div id="scrollerlist" style="overflow:auto; height:97%; width: 100%">
