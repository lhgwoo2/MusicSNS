...
<script type="text/javascript">
  ...
  $(function(){
     $('#page-selection').bootpag({
          ...
          page: ${page},         // ${curPage}
          maxVisible: 5,      // rpp,  서버로 전달이 되어야 한다. totalPages를 구하는데 사용
          leaps: true,
          firstLastUse: true,
          first: '←',
          last: '→',
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
     ...
     <!-- 게시글 쓰기 영역 -->
 	 ...
 	 <p style="color: white;">내가 올린 홍보 리스트</p> 

     <a href="<c:url value='/promotion/upload'/>"><button style="float: right;" type="button" class="btn btn-primary">홍보 올리기</button></a>
     <br><br>
     <hr>
     <br>
         <div class="row" id="promotionlist">
       <c:forEach var="vo" items="${list}" begin="0" end="2" varStatus="state">
          <div class="col-md-4">
               <div class="thumbnail">
               <p><img src="/SNS/resources/profileImage/${vo.proFilFileName}" style="width: 70px; height: 70px;"> 
               <span>${vo.author}</span>
   ...
   <div id="page-selection" align="center"></div>
	<form id="searchForm" method="get" action="myLoadPromotion2">
    <span class="col-xs-2">
