...
function update() {
	var serialData = {};
	serialData.updatePwd=$('#newPwd').val();
	serialData.pwd=$('#oldPwd').val();
	serialData.id='${secName}';
	$.ajax({
		url:'pwdUpdate2',
		data:serialData,
		type:'post',
		...
		success:function(result){
			if(result.result) {
				alert('비밀번호변경 성공!');
				 location.href='myInfo?id=${secName}'
...
<body onload="initialize()" style="background-image: url('/SNS/resources/background/galaxy.jpg');">
					...
					<div class="card card-signup">
						...
						<div class="content">
							<div class="form-group">
	                         <input type="password" class="form-control" id="oldPwd" placeholder="변경하기시 전 비밀번호를 입력">
	                      	</div>   
			 				<div class="form-group">
	                         <input type="password" class="form-control" id="newPwd" placeholder="변경하실 비밀번호 입력">
	                      	</div>                          
						</div>
						<div class="footer text-center">
							<button type="button" onclick="update();" class="btn btn-primary">비밀번호 변경</button><br>	
						</div>		
					</div>
				</div>
			</div>
