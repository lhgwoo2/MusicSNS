...
function update() {
	...
	serialData.id=$('#id').val();
	$.ajax({
		url:'searchPwdUpdateAjax',
		data:serialData,
		type:'post',
		dataType:'json',
						...
						<div class="card card-signup">
							<form id="saveForm" method="post">  
								<div class="header header-primary text-center">
									<h4 style="color: white;">PWD 찾기</h4>
								</div>
								<div class="content">

                      <div class="form-group">
                      	 <input type="hidden" id="id" name="id" value="${id}">
                      	 <input type="password" id="Pwd" class="form-control input-sm" placeholder="변경할 비밀번호">
                      </div>   
                      
								</div>
								<div class="footer text-center">
								<button type="button"  class="btn btn-primary" onclick="update()">비밀번호 변경</button>
								</div>
							</form>
						</div>
					</div>
...
<input type="hidden" id="id" name="id" value="${id}">
	<table>
		<tr><th>변경할 비밀번호:</th><td> <input type="password" id="Pwd"></td></tr>
	</table>
	<button type="button" onclick="update()">비밀번호 변경</button>
</form>
</body>
</html>