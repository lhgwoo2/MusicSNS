...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
     ...
     <br>
         ...
         <c:forEach var="vo" items="${list}" begin="0" end="2" varStatus="state">
          <div class="col-md-4">
               <div class="thumbnail">
               <p><img src="/SNS/resources/profileImage/${user.proFilFileName}" style="width: 70px; height: 70px;"> 
               <span>${vo.author}</span>
   ...
   <div id="page-selection" align="center"></div>
    ...
    <form id="searchForm" method="get" action="bookmarkPromotion">
    <span class="col-xs-2">
