...
var idc="aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
$(function(){
   ...
   var options = {
      ...
      {
         if(res.s){
            alert("축하합니다!  회원가입에 성공하셨습니다! 로그인 화면으로 이동합니다");
            location.href="login";  
         }else{
            alert("회원가입을 실패 하셨습니다.. 다시 한번 시도해 주세요");
         }
...
var auth = "${auth}";
      ...
      if (auth == "authenticated") {
         ...
         $('input[name=button1]').removeAttr("disabled");
         $('input[name=id]').removeAttr("disabled");
         $('input[name=password]').removeAttr("disabled");
         $('input[type=submit]').removeAttr("disabled");
         $('input[type=birth]').removeAttr("disabled");
         $('input[type=gender]').removeAttr("disabled");
         $('input[type=myregion]').removeAttr("disabled");

         alert('${email}이 확인되었습니다.');
         
      } else {
         $('[name=id]').attr("disabled", "disabled");
         $('[name=pwd]').attr("disabled", "disabled");
         $('[name=btn]').attr("disabled", "disabled");
         $('[name=birth]').attr("disabled", "disabled");
         $('[name=gender]').attr("disabled", "disabled");
         $('[name=myregion]').attr("disabled", "disabled");
      }
});

function check() {
   var email = {};
   email.receiver = $('[name=email]').val();
   $.ajax({
      url : 'email',
      data : email,
      type : 'post',
      ...
      success : function(result) {
         if (result.sent) {
            alert('회원가입 인증 메일을 전송 하였습니다.');
         } else {
            alert('입력하신 이메일은 이미 사용중 입니다 다른 이메일을 사용해 주세요.');
         }
      },
      error : function(xhr, status, error) {
         alert(error);
...
<body class="signup-page" style="background-image: url('/SNS/resources/background/galaxy.jpg');">
    ...
    <div class="wrapper">
		<div class="header header-filter" style="background-image: url('/SNS/resources/profileImage/city.jpg'); background-size: cover; background-position: top center;">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
                   			<form role="form"  id="input" method="post" enctype="multipart/form-data" action="add">
								...
								<div class="content">
            					 ...
            					 <label for="cma_file">프로필 선택</label>
                					<input type="file" name="profilfile" id="cma_file" accept="image/*" capture="camera" class="form-control input-sm" onchange="getThumbnailPrivew(this,$('#cma_image'), this.value)" />
              							 <div id="cma_image" style="width:302px; border:1px solid #000;display:none; margin-left: 15px;"></div>
                  							<span id="imgpre" style="margin-left: 15px;"><img src="/SNS/resources/profileImage/default.jpg" border="0" alt="" style="width:300px;"/></span>
               					</div>
                         ...
                         <input type="text" name="email"  class="form-control input-sm floatlabel" placeholder="Email Address">
                            </div>
                         </div>
                         
                         <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                            	<button type="button" name="button" onclick="check();" class="btn btn-primary">유효성 검사</button>
                            </div>
                         </div>
                      </div>
                      ...
                      <div class="row">
                         <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                         <input type="text" name="id"  class="form-control input-sm floatlabel" placeholder="ID">
                            </div>
                         </div>
                         
                         <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                            	<button type="button" name="button1" onclick="idCheck();"  class="btn btn-primary">중복 검사</button>
                            </div>
                         </div>
                      </div>
                      ...
                      <div class="form-group">
                         <input type="date" name="birth" class="form-control input-sm" >
                      </div>      
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                        <input type="radio" name="gender" value="남자" checked="checked" class="form-control input-sm" >남자
                            </div>
                         </div>
                         
                         <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                               <input type="radio" name="gender" value="여자" class="form-control input-sm" >여자
                            </div>
                         </div>
                      </div>
         
                               <div class="form-group">
                         <input type="text" name="myregion"  class="form-control input-sm floatlabel" placeholder="My Region">
                      </div>   
