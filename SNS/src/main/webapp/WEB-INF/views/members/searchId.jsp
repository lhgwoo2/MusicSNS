...
function searchId() {
	...
	$.ajax({
		...
		success:function(res){
			if(res.result){
				alert("회원님의 이메일로 아이디가 전송 되었습니다.");
			}
			else{
				alert("이메일을 다시 한번 확인하여 주세요");
			}
					...
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
								<div class="header header-primary text-center">
									<h4 style="color: white;">ID 찾기</h4>
									<span style="color: white;">회원가입시 입력 하셨던 E-mail을 입력해 주세요</span>>
								</div>
								<div class="content">
                         <input type="text" id="email" class="form-control input-sm" placeholder="E-mail">
								...
								<button type="button" name="button" class="btn btn-primary" onclick="searchId();">유효성검사</button>
