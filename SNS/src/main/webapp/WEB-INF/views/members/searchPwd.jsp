...
function email() {
	...
	$.ajax({
		...
		success:function(res){
			if(res.result){
				alert("회원님의 이메일로 인증 메일이  전송 되었습니다.");
			}
			else{
				alert("아이디와 이메일을 다시 한번 확인하여 주세요");
			}
					...
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
								<div class="header header-primary text-center">
									<h4 style="color: white;">PASSWORD 찾기</h4>
									<span style="color: white;">회원가입시 입력 하셨던</span> <br><span style="color: white;">아이디와 이메일을 입력해 주세요</span>
								</div>
								<div class="content">
                      ...
                      <div class="form-group">
                         <input type="text" id="id" class="form-control input-sm" placeholder="ID">
 						 ...
 						 <input type="text" id="email"  class="form-control input-sm" placeholder="E-mail">
								...
								<button type="button" name="button"  class="btn btn-primary" onclick="email();">이메일인증</button>									
								</div>
...
<!-- <div id="pwd">
회원가입시 입력 하셨던 아이디와 이메일을 입력해 주세요<br>
ID:<input type="text" id="id">
EMAIL:<input type="text" id="email"><button type="button" name="button" onclick="email();">이메일인증</button><br>
									<button type="button" name="button" onclick="searchPwd();">Password검사</button>
</div>  -->
