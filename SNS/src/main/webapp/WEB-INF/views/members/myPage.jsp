...
<script>
function deleted() {
	if(!confirm('정말로 게시글을 삭제하시겠어요?')) return;
	var serialData = $('#boardForm').serialize();
...
<body class="signup-page"  onload="initialize()" style="background-image: url('/SNS/resources/background/galaxy.jpg');">
<div id="listpage">
					...
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
								<div class="header header-primary text-center">
									<h4 style="color: white;">내 정보 보기</h4>
								</div>
								<div class="content">
					  <div class="form-group" >
                  		    <span id="imgpre" >
                  		    <img src="/SNS/resources/profileImage/${user.proFilFileName}" style="width: 200px; height: 200px; margin: 20%; border: 0px; " alt="Circle Image" class="img-circle img-responsive img-raised">
                  		    </span>
						</div>
					  <div class="form-group">
						<span> ID : ${user.id}</span><br>
						<span> E-MAIL : ${user.email}</span><br>
						<span> BIRTH : ${user.birth}</span><br>
						<span> GENDER : ${user.gender}</span><br>
						<span> REGION : ${user.myregion}</span><br><br><br>
                      </div>                      
								</div>
						</div>
					</div>
