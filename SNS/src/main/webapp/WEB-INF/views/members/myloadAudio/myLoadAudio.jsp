  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
     ...
     <!-- 게시글 쓰기 영역 -->
 	 ...
 	 <p style="color: white;">내가 올린 음원 리스트</p>
   
      <a href="<c:url value='/recodes/writeForm'/>"><button style="float: right;" type="button" class="btn btn-primary">녹음 게시물올리기</button></a>
      <br><br>
     <hr>
     <br>
         <div class="row" id ="recodelist">
   ...
   <div id="page-selection" align="center"></div>
    ...
    <form id="searchForm" method="get" action="myLoadAudio2">
    <span class="col-xs-2">
