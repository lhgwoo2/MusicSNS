...
<script type="text/javascript">
  ...
  $(function(){
     $('#page-selection').bootpag({
          ...
          page: ${page},         // ${curPage}
          maxVisible: 3,      // rpp,  서버로 전달이 되어야 한다. totalPages를 구하는데 사용
          leaps: true,
          firstLastUse: true,
          first: '←',
          last: '→',
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left">
     <!-- 게시글 쓰기 영역 -->
 	 ...
 	 <p style="color: white;">내가 올린 동영상 리스트</p>
 
     <a href="<c:url value='/video/write'/>" ><button style="float: right;" type="button" class="btn btn-primary">동영상 올리기</button></a>
     <br><br>
     <hr>
     <br>
	         ...
	         <c:forEach var="video" items="${list}" begin="0" end="2" varStatus="state">
		         ...
		         <span class="caption" style="float: right;">
		               <sec:authorize access="${secName==video.author}">
		                        <span>
		                           <a href="/SNS/video/videoupdate?num=${video.num}"><button type="button"class="btn btn-primary" style="width: 80px; height: 40px;">수정 <img src="/SNS/resources/markImage/edit.png" style="width: 18px; height: 18px;"></button> </a>
		                        </span>
		                          <span>
   ...
   <div id="page-selection" align="center"></div>
    ...
    <form id="searchForm" method="get" action="myLoadVideo2">
    <span class="col-xs-2">
