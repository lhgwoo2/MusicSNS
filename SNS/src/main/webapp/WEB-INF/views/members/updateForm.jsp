...
<script type="text/javascript">
	...
	$(function() {
		// 	$("[name=author]").attr("readonly",true).attr("disabled",false);
		var options = {
			success : function(res) {
				if (res) {
					alert("성공");
					location.href = "myInfo?id=${info.id}";
				}else
					alert('실패');
			},
		...
		function getThumbnailPrivew(html, $target, value) {
		    if (html.files && html.files[0]) {
		        ...
		        reader.onload = function (e) {
		            ...
		            $target.html('<img src="' + e.target.result + '" border="0" alt="" style="width:300px;"/>');
		        }
...
<body class="signup-page" style="background-image: url('/SNS/resources/background/galaxy.jpg');">
   ...
   <!--navbar 오른쪽 부분 -->
 		<div class="collapse navbar-collapse" id="example-navbar-primary">
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li>
                    <a href="/SNS/logout" style="color: white;"><sec:authentication property="name"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-log-in"></span> Log Out</a>
                 </li>   
                  </sec:authorize>
            </ul>
         </div>
...
<div class="container-fluid text-center">
  <div class="row content">
	      ...
	      <p><a href="bookmarkVideo">북마크 비디오</a></p>
	 	  ...
	 	  <p><a href="myLoadVideo?num=${num}">내가 올린 비디오</a></p>
	 	  <p><a href="myLoadAudio?num=${num}">내가 올린 오디오</a></p>
	 	  <p><a href="myLoadPromotion?num=${num}">내가 올린 홍보</a></p>
	      <p><a href="<c:url value='/mypage/myInfo?id=${secName}'/>">내정보보기</a></p>
	      <p><a href="updateForm?num=${num}">회원정보수정</a></p>
	      <p><a href="pwdUpdate?num=${num}">비밀번호변경</a></p>
	      <p><a href="deletAccount?num=${num}">회원탈퇴</a></p>
	   </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
					...
					<form id="boardForm" action="updateInfo" method="post" enctype="multipart/form-data">
								<div class="header header-primary text-center">
									<h4 style="color: white;">수정할 정보를 입력해 주세요</h4>
								</div>
								<div class="content">

					  <div class="form-group">
       							<div class="filebox">
            					 <label for="cma_file" >프로필 선택</label>
                					<input type="file" name="profilfile" id="cma_file" accept="image/*" capture="camera" class="form-control input-sm" onchange="getThumbnailPrivew(this,$('#cma_image'), this.value)" style="cursor: pointer;"/>
              							 <div id="cma_image" style="width:302px; border:1px solid #000;display:none; margin-left: 15px;"></div>
                  							<span id="imgpre" style="margin-left: 15px;"><img src="/SNS/resources/profileImage/${user.proFilFileName}" border="0" alt="" style="width:300px;"/></span>
               					</div>
						</div>
					  <div class="form-group">
						<input type="hidden" name="id" value="${secName}"><br>
						<div class="form-group">
            				<label class="control-label col-sm-4" >이메일</label>
           					 <div class="col-sm-8">
            				 <input type="text" name="email" class="form-control input-sm floatlabel"  value="${info.email}">
           					 </div>
        				  </div>
						
						<div class="form-group">
            				<label class="control-label col-sm-4" >사는 지역</label>
           					 <div class="col-sm-8">
            				<input type="text" name="myregion" class="form-control" value="${info.myregion}">
           					 </div>
        				  </div>
