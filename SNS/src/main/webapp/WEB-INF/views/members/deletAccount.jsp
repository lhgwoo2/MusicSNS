...
function deleteAccount() {
	...
	$.ajax({
		...
		success:function(result){
			if(result.result) {
				alert('탈퇴성공! 로그인화면으로 이동합니다.');
				 location.href='/SNS/members/login'
				...
				<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
					<div class="card card-signup">
						...
						<div class="footer text-center">
							<button type="button" onclick="deleteAccount()" class="btn btn-primary">탈퇴하기</button><br>	
						</div>		
					</div>
				</div>
			</div>
