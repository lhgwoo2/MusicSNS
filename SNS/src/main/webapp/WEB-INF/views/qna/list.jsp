...
$(function(){
	 $('#page-selection').bootpag({
		total: ${navi[0].totalRows},
	    page: ${page},
	    maxVisible: 5, //rpp 서버로
	    leaps: true,
	    firstLastUse: true,
	    first: '←',
	    last: '→',
...
<body style="background-image: url('/SNS/resources/background/qnabackground.jpg');">
  ...
  <div class="row content">
    ...
    <br>
     ...
     <div class="main main-raised">
      ...
      <a href="write"><button type="button" class="btn btn-primary" style="float: right;">글쓰기</button></a>
      <a href="list" style="text-decoration: none"><button type="button" class="btn btn-primary" style="float: right;">전체목록</button></a>
      <br><br>
      <hr>
      <p></p>
     ...
     <div class="container text-center" style="min-width:900px;">
      <sec:authentication property="name" var="secName"/>
		...
		<br>
			...
			<form id="search" action="getSearch" method="post">
				<span class="col-md-3">					
			<select id="select" name="conten" class="btn btn-primary">
				<option>제목</option>
				<option>작성자</option>
			</select>
			</span>
			...
			<span class="col-md-6">
			 <input type="text" name="key" class="form-control"  placeholder="검색어를 입력해 주세요"/>
			 </span>
