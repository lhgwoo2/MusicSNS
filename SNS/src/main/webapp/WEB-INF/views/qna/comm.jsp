...
<script type="text/javascript">
	function comm(){
		...
		var serialData = {};
		serialData.ref = num;
		serialData.title = title;
		serialData.contents = contents;
		serialData.author = author;
  ...
  <div class="row content">
    ...
    <br>
     ...
     <div class="container text-center" style="min-width:900px;">
			<form id='addEmp' method="post" action="comm1">
          
          <div class="form-group">
            <label class="control-label col-sm-2">답글제목:</label>

            <div class="col-sm-10">
             <input name='title' value="${title}" type="text" class="form-control" placeholder="답글의 제목을 입력해 주세요">
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" >답글 내용:</label>
            <div class="col-sm-10">
              <input name='contents' value="${contents}" type="text" class="form-control" placeholder="답글의 내용을 입력해주세요" style="resize: none; height: 400px;">
            </div>
          </div>
		...
		<button type="button" onclick="comm();" class="btn btn-primary" >저장</button>
      </div>
