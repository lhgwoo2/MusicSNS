	...
	<!--navbar 오른쪽 부분 -->
			<div class="collapse navbar-collapse" id="example-navbar-primary">
				<ul class="nav navbar-nav navbar-left">
			        ...
			        <li class="active"><a href="<c:url value='/qna/list'/>">Q&A</a></li>
      ...
      <sec:authentication property="name" var="secName"/>
             ...
             <div id="content">
				<table class="table table-hover" style="min-width:900px;">
					...
					<tr>
					<td><h6><input name="num" type="hidden" value="${desc.num}">${desc.num}</h6></td>
					<td><h6><input name="title" type="hidden" value="${desc.title}">${desc.title}</h6></td>
					<td><h6>${desc.contents}</h6></td>
					<td><h6>${desc.author}</h6></td>
					<td><h6>${desc.regdate}</h6></td>
					</tr>
			</table>
		</div>	
		<br>
...
<span class="col-md-1" style="margin-right: 20px">
	<a href="list"><button class="btn btn-primary" type="button">목록보기</button></a> &nbsp;
</span> 

<span class="col-md-1" style="margin-right: 20px">
	<form id="commEmp" action="comm" method="post">
		<input name="num" type="hidden" value="${desc.num}">
		<button type="button" onclick="comm();" class="btn btn-primary">답글달기</button>
	</form>
</span>
<c:if test="${secName == desc.author}">
<span class="col-md-1" style="margin-right: 20px">
	<form id="updateEmp" action="modi" method="post">
		<input name="num" type="hidden" value="${desc.num}">
		<button type="button" onclick="modi();" class="btn btn-primary" >정보 수정</button>
	</form>
</span>
<span class="col-md-1" style="margin-right: 20px">
	<form id="deleted" action="del" method="post">
		<input name="num" type="hidden" value="${desc.num}">
		<button type="button" onclick="del();" class="btn btn-primary">삭제</button>
	</form>
</span>  
</c:if> 
...
<span class="col-md-4">
                    ...
                    <div class="form-group" id="page-selection"></div>	
      </div>
