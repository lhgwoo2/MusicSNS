  ...
  <div class="row content">
    ...
    <br>
     ...
     <div class="container text-center" style="min-width:900px;">
			<form id='addEmp' method="post" action="modi1">
          
            <div class="form-group">
            <label class="control-label col-sm-2">수정할 제목:</label>

            <div class="col-sm-10">
            		<input type="hidden" name="num" value="${vo.num}">
            		<input name='title' value="${vo.title}" type="text"  class="form-control" placeholder="" >
            		<input type="hidden" name="author" value="${secName}">
            </div>
          </div>
          
          <div class="form-group">
            <label class="control-label col-sm-2" >수정할  내용:</label>
            <div class="col-sm-10">
              <input name='contents' type="text"  value="${vo.contents}" class="form-control" placeholder="" style="resize: none; height: 400px;">
            </div>
          </div>
        </form>
		<a href="list"><button class="btn btn-primary" type="button" >목록보기</button></a>
		<button type="button" onclick="modi();" class="btn btn-primary">저장</button>
      </div>
