  ...
  <div class="row content">
    ...
    <br>
     ...
     <div class="container text-center" style="min-width:900px;">
			<form id="boardForm" action="read1" method="POST">
				<input type="hidden" name="author" value="${secName}"><br>
          		<input type="hidden" name="ref" value="0">
          <div class="form-group">
            <label class="control-label col-sm-2">글제목:</label>

            <div class="col-sm-10">
             <input type="text" id="title" class="form-control" name="title" placeholder="Enter the title">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" id="contents" name="contents" placeholder="Enter comment" style="resize: none; height: 400px;" ></textarea>
            </div>
          </div>
            
        </form>
        <span  style="text-align: right;">
        <button type="button" onclick="save();" class="btn btn-primary" >저장</button>
        </span>
      </div>
    </div>
   </div>
