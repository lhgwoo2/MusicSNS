  ...
  <div class="row content">
	...
	<div class="col-sm-8 text-left">
     ...
     <!-- 게시글 쓰기 영역 -->
 	 ...
 	 <a href="upload" style="text-decoration: none;"><button style="float: right;" type="button" class="btn btn-primary">글쓰기</button></a>
 		<br>
 		<br>
 		<br>
 	  <hr>
      	...
      	<c:forEach var="vo" items="${list}" begin="0" end="2" varStatus="state">
			 <div class="col-md-4">
      			<div class="thumbnail">
      			<p><img src="/SNS/resources/profileImage/${vo.profilfile}" style="width: 50px; height: 50px;"> 
      			<span>${vo.author}</span>
      			...
      			<p>${vo.title}<span style="float: right;"><a href="desc?num=${vo.num}">상세보기</a></span></p>
       			 	 <img src="/SNS/resources/promotionListImage/${vo.filename}" alt="Pulpit Rock" style="width:100%; cursor: pointer;" onclick="doImgPop('/SNS/resources/promotionListImage/${vo.filename}')">
       			   	<span style="line-height: 30%;"><br></span>
       			    	...
       			    	<span style="float: right; margin-right: 10px; font-size: 12px;">좋아요: ${vo.likes}</span>
       			   	<hr>
       			   	<span class="caption" >
       			   	
         		 		<span style="font-size: 12px;"id="mark${vo.num}">
							<span id="mark${vo.num}">						
								<c:choose>
									<c:when  test="${vo.markid==secName}">
											<img src="/SNS/resources/thumbnailImage/bookmark.jpg" style="width: 20px; height: 20px;"><a style="cursor: pointer;" onclick="markCancel(${vo.num});" >북마크 취소하기</a>  
									</c:when>
									<c:otherwise>						
											<img src="/SNS/resources/thumbnailImage/bookmark.jpg" style="width: 20px; height: 20px;"><a style="cursor: pointer;" onclick="mark(${vo.num});" >북마크</a>     	        
									</c:otherwise>		
								</c:choose>					
							</span>
						</span>
      	...
      	<div class="row">
      	<c:forEach var="vo" items="${list}" begin="3" end="5" varStatus="state">
			 <div class="col-md-4">
      			<div class="thumbnail">
      			<p><img src="/SNS/resources/profileImage/${vo.profilfile}" style="width: 50px; height: 50px;">
      			<span>${vo.author}</span>
    ...
    <div class="col-xs-8" >
    	<span class="form-group">
    		 <input type="text" name="key" class="form-control" placeholder="Input your search keyword" style="color: white;">
		</span>
