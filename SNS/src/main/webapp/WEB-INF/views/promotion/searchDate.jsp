    ...
    dayClick: function(date, allDay, jsEvent, view) {
        ...
        if (allDay) {
            ...
            if ($(jsEvent.target).is('div.fc-day-number')) { 
				$('#selectday').html(date.toLocaleDateString()+' 일정');
            	
                // Clicked on the day number 
                var param={};
           		 param.aaa = date.toLocaleString(); 
                $.ajax({
                   url:'openingday',
                    data:param,
                    type:'post',
...
<div class="container">
    <span class="col-sm-6">
   <div id="calendar" style="background: #FFFFFF; background : rgba(0, 0, 0, 0.15);"></div>
   </span>
   <span class="col-sm-6">
   		<h3 id="selectday" style="color: white;"></h3>
      <table class="table table-hover">
      <thead style="display: inline-block;" >
      </thead>
         <tbody id="sre" style="height: 100%; display: inline-block; width: 100%; overflow: auto;">
       </tbody>
       </table>
   </span>
