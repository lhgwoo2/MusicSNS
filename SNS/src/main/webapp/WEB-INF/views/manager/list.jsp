...
<body style="background-image: url('/SNS/resources/background/managerbackground.jpg');">
      ...
      <sec:authentication property="name" var="secName"/>
             ...
             <div id="content" >
				...
				<c:forEach items="${navi}" var="report">
					<tr>
						<td>${report.num}</td>
						<td><a href="desc?num=${report.num}">${report.title}</a></td>
		...
		<br>
			...
			<span class="col-md-3">
			<select id="select" name="conten" class="btn btn-default">
				<option>제목</option>
				<option>신고자</option>
				<option>신고유형</option>
			</select> 
